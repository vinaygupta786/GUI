...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vg66122@gmail.com' ")
...
def TakeImages():
    ...
    columns = ['SERIAL NO.', '', 'ID', '', 'NAME','','MAIL ID','','CONTACT NO']
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        row = [serial, '', Id, '', name,'',mailid,'',contact]
...
def submit():
    ...
    pwd = ""
    database = "attendance"'''
    con = connect(host="localhost",user="root",pwd="",database="attendance")
    con.cursor()
    ...
    emailid = mailid
    econtact = contact
    string = "insert into employee values (%d,'%s','%s','%d')"%(eid,ename,emailid,econtact)
    con.execute(string)
    con.fetchall()
    print(eid,ename,emailid,econtact)
    con.commit()
    con.close()
...
def TrackImages():
    ...
    while True:
        ...
        cv2.imshow('Scanning Barcode', im)
    ...
    with open("StudentDetails\StudentDetails.csv", 'r') as csvFile1:
                reader1 = csv.reader(csvFile1)
            #for lines in reader1:
                m = float(df.loc[df['SERIAL NO.'] == serial]['CONTACT NO'].values)
                account_sid = ''#your twillo acount sid
                auth_token = ''#your token id
                client = Client(account_sid, auth_token)
                message = client.messages.create(  
                              messaging_service_sid='', 
                              body='Hello ' + bb  + ' your attendance has been captured' + timeStamp,      
                              to=m)
                print(message.sid)
...
lbl3 = tk.Label(frame2, text="Enter Mail ID",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl3.place(x=80, y=220)

txt3 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt3.place(x=30, y=250)

lbl4 = tk.Label(frame2, text="Enter Contact No",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl4.place(x=80, y=290)

txt4 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt4.place(x=30, y=320)
...
lbl5 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#00aeff"  ,height=1 ,font=('times', 17, ' bold '))
...
clearButton3.place(x=335, y=250)
...
clearButton4.place(x=335, y=320)

clearButton5 = tk.Button(frame2, text="Submit", command=submit  ,fg="black"  ,bg="#ea2a2a"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton5.place(x=205, y=350)
